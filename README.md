...
![CI/CD](https://github.com/mohitmatte-04/skill-agent-lnd/actions/workflows/ci-cd.yml/badge.svg)
![Code Quality](https://github.com/mohitmatte-04/skill-agent-lnd/actions/workflows/code-quality.yml/badge.svg)
[![Documentation](https://img.shields.io/badge/docs-mkdocs-blue)](https://mohitmatte-04.github.io/skill-agent-lnd/)
...
Google's [Agent Starter Pack](https://googlecloudplatform.github.io/agent-starter-pack/) is a feature-rich framework with extensive tooling and multi-platform CI/CD options. `skill-agent-lnd` takes a different approach:
...
This project distills proven patterns from the Starter Pack while prioritizing build efficiency, deployment simplicity, and infrastructure transparency. Use the Starter Pack for rapid prototyping with Agent Engine; use `skill-agent-lnd` for thoughtfully-curated developer experience and production deployments requiring optimization and control.
